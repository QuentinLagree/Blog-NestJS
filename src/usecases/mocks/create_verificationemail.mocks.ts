...
export const createVerificationEmailMock = (overrides: Partial<VerificationTokens> = {}) => ({
    id: 1,
...
export const createOtherVerificationEmailMock = (overrides: Partial<VerificationTokens> = {}) => ({
  id: 1,
...
export const createVerificatioEmailParamSetTokenMock = (overrides: Partial<VerificationTokens> = {}) => ({
    email: "johndoe@gmail.com",
    code: MockToken,
    expired_at: new Date(Date.now() + TOKEN.EXPIRED_TOKEN),
    ...overrides
