...
export class PostsService {
  ...
  async show(uniqueProperties: Prisma.PostWhereUniqueInput, published: Boolean = false): Promise<Post> {
      try {
        const post = await this._prisma.post.findUnique({ where: uniqueProperties })
